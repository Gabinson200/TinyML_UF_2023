...
// Custom models and test data
#include "tensorflow/lite/micro/examples/micro_speech/models/conv_model_data.h"
...
constexpr size_t kArenaSize = 180000;  // xtensa p6
...
TfLiteStatus LoadMicroSpeechModelAndPerformInference(
  ...
  const tflite::Model* model =
      tflite::GetModel(g_conv_model_model_data);
